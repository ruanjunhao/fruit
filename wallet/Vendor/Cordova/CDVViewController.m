...
{
    // Modify by wxzhao
    CGRect webViewBounds = _contentView.bounds; //self.view.bounds;
    webViewBounds.origin.y = _topOffset;
    webViewBounds.size.height -= _topOffset;
    //_contentView.frame = webViewBounds;

    //webViewBounds.origin = _contentView.bounds.origin;//self.view.bounds.origin;
    ...
    if (!self.webView) {
        ...
        [_contentView sendSubviewToBack:self.webView];
